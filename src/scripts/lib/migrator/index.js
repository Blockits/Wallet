...
export default class Migrator extends EventEmitter {
  ...
  constructor(opts={}) {
    ...
    // use specfified defaultVersion or highest migration version
    this.defaultVersion =
  ...
  async migrateData(versionedData = this.generateInitialState()) {
    // get all migrations that have yet been run
    ...
    for (const migration of pendingMigrations) {
      try {
        ...
        err.message = `Wallet Migration Error #${migration.version}: ${originalErrorMessage}`;
