import { ObservableStore } from '@blockits/obs-store';
import { getPersistentState } from '@blockits/controllers';

/**
 * @typedef {import('@blockits/controllers').ControllerMessenger} ControllerMessenger
 */
 ...
 */
export class ComposableObservableStore extends ObservableStore {
  /**
   ...
   * extends one of the two base controllers in the `@blockits/controllers`
   * package.
   ...
   *   controllers in the `@blockits/controllers` package.
   */
