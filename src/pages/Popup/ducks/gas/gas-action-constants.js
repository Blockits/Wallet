...
// Actions
export const RESET_CUSTOM_DATA = 'wallet/gas/RESET_CUSTOM_DATA';
export const SET_CUSTOM_GAS_LIMIT = 'wallet/gas/SET_CUSTOM_GAS_LIMIT';
export const SET_CUSTOM_GAS_PRICE = 'wallet/gas/SET_CUSTOM_GAS_PRICE';
